...
import com.vornitologist.VornitologistOfflineModeExtension;

@Connect(VornitologistOfflineModeExtension.class)
public class VornitologistOfflineConnector extends OfflineModeConnector {
