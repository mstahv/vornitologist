...
import com.vaadin.addon.touchkit.gwt.client.vcom.SwipeViewConnector;
...
import com.vornitologist.widgetset.client.VornitologistOfflineConnector;
...
public class WidgetLoaderFactory extends TouchKitBundleLoaderFactory {
    ...
    public WidgetLoaderFactory() {
        ...
        usedConnectors.add(VornitologistOfflineConnector.class.getName());
        usedConnectors.add(WindowConnector.class.getName());
        usedConnectors.add(CustomFieldConnector.class.getName());
        usedConnectors.add(HorizontalButtonGroupConnector.class.getName());
        usedConnectors.add(SwipeViewConnector.class.getName());
    }
