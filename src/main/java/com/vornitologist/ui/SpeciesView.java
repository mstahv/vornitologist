...
import com.vornitologist.ui.AddObservationView.ObservationAddedCallback;
...
public class SpeciesView extends NavigationView implements
        Button.ClickListener, ObservationAddedCallback, ClassificationSubView {
    ...
    private void buildView(Species species) {
        ...
        // more pictures (dummy view)
        componentGroup.addComponent(new Button("More photos",
                new ClickListener() {
            @Override
            public void buttonClick(ClickEvent event) {
                UI.getCurrent().addWindow(
                        new MorePicturesView(SpeciesView.this.species));
            }
        }));
