...
import com.vornitologist.ui.LocationSelectorMap.LocationSelectedCallback;
import com.vornitologist.util.Translations;
import com.vornitologist.util.UploadImageScaler;
...
public class AddObservationView extends NavigationView implements
    ...
    private CustomField<Species> species;
    ...
    public AddObservationView(Species s, ObservationAddedCallback cb) {
        ...
        observation.setObserver(VornitologistUI.getApp().getUser());
        ObservationPoint observationPoint = new ObservationPoint();
        observationPoint.setLatitude(VornitologistUI.getApp()
                .getCurrentLatitude());
        observationPoint.setLongitude(VornitologistUI.getApp()
                .getCurrentLongitude());
        ...
        // Configure fields
        species = new SpeciesSelector(tr,locale);
        species.setCaption(tr.getString("species"));
        ...
        obsPointFieldGroup.setItemDataSource(new BeanItem<ObservationPoint>(
                observationPoint));
        ...
        chooseFromMap.setStyleName(StyleNames.BUTTON_LINK);
