 ...
 */
public class SettingsView extends NavigationView implements VornitologistMainView {
    ...
    private void buildView() {
        ...
        button.addClickListener(new Button.ClickListener() {
            public void buttonClick(ClickEvent event) {
                ((VornitologistUI) UI.getCurrent()).goOffline();
            }
        });
        ...
        Locale curlocale = VornitologistUI.getApp().getLocale();
        ...
        languageSelect
                .addValueChangeListener(new Property.ValueChangeListener() {
                    public void valueChange(ValueChangeEvent event) {
                         ...
                         */
                        VornitologistUI.getApp().setLocale(
